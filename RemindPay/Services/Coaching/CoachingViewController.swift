...
protocol CoachingViewDisplayLogic: AnyObject {
    func displayRefreshAllUsers(using vm: Library.Refresh.ViewModel)
}

final class CoachingViewController: UIViewController {
...
//    private var presenter: CoachingViewPresentingLogic?
...
//        interactor?.fetchAllUsers(request: .init())
    ...
    private func setupHeader() {
        ...
        header.configure(with: .init(iconImage: .system(name: "graduationcap"), background: nil, title: "Heyy Pranjal"))
    }
...
extension CoachingViewController: CoachingViewDisplayLogic {
...
extension CoachingViewController: GeneralHeaderDelegate {
